...
uploaded_file = st.file_uploader('Upload an image', type=['png', 'jpg', 'jpeg']) # file uploader
segment_button = st.button('Segment Image', use_container_width=True) # button to segment image
